                ...
                <div className="mt-4 pt-4 border-t" style={{ borderColor: 'var(--border-color)' }}>
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 p-2 border rounded-lg bg-gray-50 text-gray-700"
                            disabled={isLoading}
                        />
                        <button onClick={handleSendMessage} className="btn-primary px-4 py-2 rounded-lg" disabled={isLoading}>
